          ...
          <tbody className="bg-white divide-y divide-gray-200">
            {vehicles.map((vehicle, index) => (
              ...
              >
                ...
                <td className="px-2 py-2 text-sm text-gray-500">{vehicle.situacaoAnaliseDocumental || '-'}</td>
                <td className="px-2 py-2 text-sm text-gray-500">{vehicle.situacaoAnaliseFiscal || '-'}</td>
              </tr>
            ))}
          </tbody>
        </table>
