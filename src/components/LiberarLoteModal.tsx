...
const LiberarLoteModal: React.FC<LiberarLoteModalProps> = ({ isOpen, onClose, vehicles, onConfirm }) => {
      ...
      <div className="bg-white rounded-lg shadow-xl max-w-4xl w-full max-h-[90vh] flex flex-col">
        <div className="border-b px-6 py-4">
          <h2 className="text-xl font-semibold text-gray-900">
            Deseja confirmar liberação para criação de lote de transferência de CR
          </h2>
        </div>
...
export default LiberarLoteModal;