        ...
        <div>
          <div className="border-b border-gray-200 mt-8">
            <nav className="-mb-px flex space-x-8" aria-label="Tabs">
              <button
                onClick={() => { setActiveTab('radar'); setCurrentPage(1); }}
                className={`${
                  activeTab === 'radar'
              ...
              <button
                onClick={() => { setActiveTab('acompanhamento'); setCurrentPage(1); }}
                className={`${
          ...
          {activeTab === 'acompanhamento' && <AcompanhamentoTab vehicles={paginatedAcompanhamentoVehicles} totalVehicles={filteredAcompanhamentoVehicles.length} />}
           {activeTab === 'acompanhamento' && 
             <Pagination 
